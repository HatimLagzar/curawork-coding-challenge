<div class="my-2 shadow text-white bg-dark p-1" id="">
  <div class="d-flex justify-content-between">
    <table class="ms-1">
      <td class="align-middle">{{ $relationship->getOtherUser()->getName() }}</td>
      <td class="align-middle"> -</td>
      <td class="align-middle">{{ $relationship->getOtherUser()->getEmail() }}</td>
    ...
    <div>
      <button style="width: 220px" id="get_connections_in_common_" class="btn btn-primary" type="button"
        ...
        Connections in common ({{ $relationship->getCommonConnections()->count() }})
      </button>
  ...
  <div class="collapse" id="collapse_">
    ...
    <div id="content_" class="p-2">
      {{-- Display data here --}}
      @foreach($relationship->getCommonConnections() as $relationship)
        <x-connection_in_common :name="$relationship->getOtherUser()->getName()" :email="$relationship->getOtherUser()->getEmail()"/>
      @endforeach
    </div>
